    ...
    <div id="index-banner" className="parallax-container parallax-container-main">
      ...
      <div className="section no-pad">
        <div className="container upperHeader">
          ...
          <div className="row reset-marg-pad">
            <div className="col s12 m12">
              <h1 className="reset-marg-pad header blue-grey-text text-darken-4" data-aos="fade-right"
          ...
          <div className="row reset-marg-pad positionTitle">
            <div className="col s12 m12">
              <h4 className="reset-marg-pad header blue-grey-text text-darken-4" data-aos="fade-up" data-aos-duration="2500"
          ...
          <div className="row reset-marg-pad welcomeText">
            <div className="col s12">
              <h5 className="reset-marg-pad header blue-grey-text text-darken-4 center" data-aos="fade-up" data-aos-duration="2500"
        ...
        <div className="container bottomHeader">
          ...
          <div className="row reset-marg-pad">
            <div className="col s12 m12">
              <h2  className="arrowIcon center blue-grey-text text-darken-4" data-aos="fade-up" data-aos-duration="2500" data-aos-delay="3000" data-aos-offset="0">
                <a href="#AboutMe" className="blue-grey-text text-darken-4">
